...
# Issues with torch & torchvision version related to torchrun; checking:
#RUN pip3 install opencv-python==4.1.0.25 torch==1.1.0 torchvision==0.3.0 numpy==1.13.3 pandas==0.24.1 networkx==2.2
RUN pip3 install opencv-python==4.1.0.25 torch==1.10.0 torchvision==0.11.0 numpy==1.13.3 pandas==0.24.1 networkx==2.2
#RUN pip3 install opencv-python==4.1.0.25 torch==1.11.0 torchvision==0.12.0 numpy==1.13.3 pandas==0.24.1 networkx==2.2
